 ...
 * ****************************************************************
 *
 * Package: work.mysql Filename: EntityMysql.java Description: Copyright:
 * Copyright (c) liuqiang 2017
 * 
 * @author: liuqiang_pc
 * @version: 1.0.0 Create at: 2017年12月7日 下午3:34:08 2017年3月9日 上午10:45:55 - first
 *           revision
 *
 ****************************************************************
 */
public class MysqlJavaService {
	...
	public void createMapper(String[] colnames, String[] colTypes, String tablename) throws IOException {
		...
		String fileName = directory.getAbsolutePath() + getSrcPath() + packageOutPath.replace(".", File.separator)
				+ File.separator + "I" + initcap(tablename.toLowerCase()) + "Service.java";
	...
	private void processAllMethod(StringBuffer sb) {
		if (primaryKey.contains(",")) {
			...
			sb.append("\tpublic List<" + initcap(tablename.toLowerCase()) + "> findBy("
					+ initcap(tablename.toLowerCase()) + " data);\n ");
